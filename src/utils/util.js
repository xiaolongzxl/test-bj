import { secondUploadApi, uploadApi } from '@/api/file';
export const fileType = (type, isBig = false) => {
  const fileType = [
    ...
    { type: 'image', includes: ['jpg', 'jpeg', 'png', 'gif'], icon: 'self', bigIcon: 'self-big', name: '图片' },
    ...
    { type: 'wjj', includes: [1], icon: 'file/file/icon-wenjianjia.png', bigIcon: 'file/file/icon-wenjianjia-big.png', name: '文件夹', value: 1 },
    {
      type: 'qyWjj',
      includes: [2],
